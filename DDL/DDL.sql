...
CREATE OR REPLACE TABLE CODIGO_CIVIL(
    id INT UNSIGNED AUTO_INCREMENT,
...
CREATE OR REPLACE TABLE CONGRESO(
    id INT UNSIGNED AUTO_INCREMENT,
    idPais INT UNSIGNED NOT NULL,
...
CREATE OR REPLACE TABLE POLITICO(
    numPasaporte VARCHAR(16),
...
CREATE OR REPLACE TABLE CIUDADANO(
    numPasaporte VARCHAR(16),
...
CREATE OR REPLACE TABLE PROPUESTA(
    id INT UNSIGNED AUTO_INCREMENT,
...
CREATE OR REPLACE TABLE DESARROLLAR (
