...
public class CongresoDAO {
    ...
    private static final String UPDATE_QUERY = "UPDATE CONGRESO SET idPais = ? WHERE id = ?";
    ...
    public void updateCongreso(Congreso congreso) throws SQLException {
        try (PreparedStatement ps = connection.prepareStatement(UPDATE_QUERY)) {
            ps.setInt(1, congreso.getIdPais());
            ps.setInt(2, congreso.getId());
            ps.executeUpdate();
        }
    }
    /**
